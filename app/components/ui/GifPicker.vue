<template>
  <div class="space-y-4">
    ...
    >
        ...
        <button
          ...
          :class="[
            ...
            selectedGif?.slug === gif.slug
              ...
              : 'border-gray-200 hover:border-gray-300 hover:scale-105 dark:border-gray-700 dark:hover:border-gray-600'
          ]"
          @click="selectGif(gif)"
        >
          <!-- GIF Image -->
          ...
          >
            <UIcon
              v-if="selectedGif?.slug === gif.slug"
      ...
      >
        <UButton
          ...
          @click="loadMore"
        >
          <UIcon name="i-lucide-chevron-down" class="mr-2" />
          Load More GIFs
        </UButton>
      </div>
    </div>
    ...
    >
      <UIcon name="i-lucide-image-off" class="h-12 w-12 text-gray-400 mb-4" />
      ...
      <UButton
        color="neutral"
        variant="outline"
        @click="search('celebration')"
      >
        <UIcon name="i-lucide-party-popper" class="mr-2" />
        Try "celebration"
      </UButton>
    </div>
      ...
      <div class="flex items-center gap-4">
        ...
        <div class="flex-1">
          ...
          <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
            This GIF will be displayed on your flashpage
          </p>
        </div>
        <UButton
          color="neutral"
...
watch(() => props.modelValue, (newValue) => {
  if (newValue && !selectedGif.value) {
    ...
    const gif = gifs.value.find(g => g.file.hd.gif.url === newValue || g.file.hd.webp.url === newValue)
    if (gif) {
